...
public class AbonnementController implements Initializable {
    ...
    @FXML
    private TableColumn<Abonnement, Image> colQrCode;
    @FXML
...
//        System.out.println("Email sent successfully...");
    ...
    public void UpdateTableAb() {
        ...
        idAbR.setCellValueFactory(new PropertyValueFactory<>("id_ab"));
        typeAbR.setCellValueFactory(new PropertyValueFactory<>("type_ab"));
        prixAbR.setCellValueFactory(new PropertyValueFactory<>("prix_ab"));
        modeDePaiementAbR.setCellValueFactory(new PropertyValueFactory<>("mode_paiement_ab"));

        listAb = abcd.getDataAb();
        System.out.println("--->  " + listAb.size());
        System.out.println("test" + listAb);
